# Round-2 prompt - Mistral

You are Mistral in the multi-agent protocol of D:\Colabs.
...
Step 1. Run `node .ai/bin/protocol-session.cjs start --agent mistral` and follow AGENTS.md.
...
- You wrote Z2 in round 1, so you do NOT challenge Z2.
- Your zones: Z1 (`gemini-z1-grammar.md`) and Z3 (`copilot-z3-diff-cert.md`).
...
Check the ROUND2.md leads for Z1 and Z3 yourself; accept none on trust. In Z3, look
closely at whether "clean tree" producer Evidence is attainable in this shared checkout.
...
Write only:
- `docs/research/2026-09-24-remediation-mapping/r2-mistral-z1-z3.md`, max 250 lines;
