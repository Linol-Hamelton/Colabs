...
| Closed frames without a receipt | 1 (F-01 only; its program is still implementing) | 2026-09-26 | R-L0-22.56 |
...
| F-06 | Validator migration council | `docs/research/archive/2026-09-25-validator-migration-council/` | S1 | major | CLOSED | 3 | 2026-09-25 | owner | ACCEPT | PROTO-DEC-0077; receipt: CR-F06-1 8fca7ae K:0 C:0 A:58 D:0 R:0 T:4 | - |
| F-07 | Cycle architecture | `docs/research/archive/2026-09-20-cycle-architecture/` | S1 | major | CLOSED | - | 2026-09-20 | owner | ACCEPT | PROTO-DEC-0041; TASK "RESOLVED 2026-09-20"; receipt: CR-F07-1 a7d8b0c K:0 C:0 A:1 D:0 R:0 T:0 | - |
| F-08 | Cycle-history dataset (script and evidence snapshot) | `docs/research/archive/2026-09-20-cycle-history/` | - | - | not a frame (measurement input to F-07) | - | - | - | - | R-L0-22.4; the dataset underlies F-16; receipt: CR-F08-1 cf4b193 K:0 C:0 A:2 D:0 R:0 T:0 | - |
| F-09 | Jev decision-fabric evaluation | `docs/research/archive/2026-09-22-jev-decision-fabric-evaluation.md` | S2 | minor | CLOSED | 1 | 2026-09-22 | owner | REJECT (adoption as a decision fabric; Jev stays advisory outside the gate); the authorised offline replay is candidate C-JEV | PROTO-DEC-0045 item 3; receipt: CR-F09-1 445a02e K:0 C:0 A:1 D:0 R:0 T:0 | - |
| F-10 | Candidate tool evaluation (CodeGraph, Serena, Graphiti, Cognee, Letta, Mem0) | `docs/research/archive/2026-09-22-kilo-candidate-tool-evaluation.md` | S1 | minor | CLOSED | 1 | 2026-09-22 | owner | REJECT (adoption; CodeGraph recorded as an alternative S1 arm of the preregistered experiment) | PROTO-DEC-0045 item 1; receipt: CR-F10-1 8b0952c K:0 C:0 A:1 D:0 R:0 T:0 | - |
| F-11 | Kernel architecture discussion and questions | `docs/research/2026-09-23-kernel-architecture/` | S1 | major | CLOSED | - | 2026-09-23 | owner | ACCEPT (the layered scheme absorbed into CORE-ARCH; `PROCEDURE-MAP.md:15-16` keeps it a discussion input, not a decision) | PROTO-DEC-0054; F-03; receipt: CR-F11-1 receipt-only K:0 C:0 A:0 D:0 R:0 T:2 | - |
| F-12 | R0 decision dataset | `docs/research/archive/2026-09-23-r0-decision-dataset/` | - | - | not a frame (measurement; `README.md:13-17`: no model is called, no outcome is evaluated) | - | - | - | - | R-L0-22.4; evidence input to the routing research and the Jev calibration discussion; receipt: CR-F12-1 d6f9c0c K:0 C:0 A:5 D:0 R:0 T:0 | - |
| F-13 | Routing research (15 questions) | `docs/research/archive/2026-09-23-routing/` | S2 | major | CLOSED | - | 2026-09-23 | owner | ACCEPT only for what entered PROTO-DEC-0047; DEFER for the remainder (D-02) | PROTO-DEC-0047; `INDEX-draft.md:9-11`, `:221` (its `:3` count is outdated); receipt: CR-F13-1 3913284 K:0 C:0 A:12 D:0 R:0 T:0 | - |
