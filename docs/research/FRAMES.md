...
| F-06 | Validator migration council | `docs/research/archive/2026-09-25-validator-migration-council/` | S1 | major | CLOSED | 3 | 2026-09-25 | owner | ACCEPT | PROTO-DEC-0077 | - |
| F-07 | Cycle architecture | `docs/research/archive/2026-09-20-cycle-architecture/` | S1 | major | CLOSED | - | 2026-09-20 | owner | ACCEPT | PROTO-DEC-0041; TASK "RESOLVED 2026-09-20" | - |
| F-08 | Cycle-history dataset (script and evidence snapshot) | `docs/research/archive/2026-09-20-cycle-history/` | - | - | not a frame (measurement input to F-07) | - | - | - | - | R-L0-22.4; the dataset underlies F-16 | - |
| F-09 | Jev decision-fabric evaluation | `docs/research/archive/2026-09-22-jev-decision-fabric-evaluation.md` | S2 | minor | CLOSED | 1 | 2026-09-22 | owner | REJECT (adoption as a decision fabric; Jev stays advisory outside the gate); the authorised offline replay is candidate C-JEV | PROTO-DEC-0045 item 3 | - |
| F-10 | Candidate tool evaluation (CodeGraph, Serena, Graphiti, Cognee, Letta, Mem0) | `docs/research/archive/2026-09-22-kilo-candidate-tool-evaluation.md` | S1 | minor | CLOSED | 1 | 2026-09-22 | owner | REJECT (adoption; CodeGraph recorded as an alternative S1 arm of the preregistered experiment) | PROTO-DEC-0045 item 1 | - |
...
| F-12 | R0 decision dataset | `docs/research/archive/2026-09-23-r0-decision-dataset/` | - | - | not a frame (measurement; `README.md:13-17`: no model is called, no outcome is evaluated) | - | - | - | - | R-L0-22.4; evidence input to the routing research and the Jev calibration discussion | - |
