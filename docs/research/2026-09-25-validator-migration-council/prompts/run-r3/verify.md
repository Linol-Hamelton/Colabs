# Launch: task:vmc-verify, verifier, first pass

- Agent name: `mistral`. Start with `node .ai/bin/protocol-session.cjs start --agent mistral`.
- Model and route: mistral-medium-3.5, vibe; effort is not settable.
