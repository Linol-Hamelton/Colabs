# Launch: task:ownerideas-r2-kimi

- Frame: `task:ownerideas-r2-kimi` (parent program: `ownerideas-revision`). This role holds for
  this frame only.
...
- Output (exactly one file): `docs/research/2026-09-26-ownerideas-revision/round2/SYNTHESIS-KIMI.md`.
- Do not open `round2/SYNTHESIS-MIMO.md` or any file under `round1/` other than the four reviews
