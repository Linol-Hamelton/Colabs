...
Draft 0.2 of CORE-ARCH stage 2 (layer L1). Not binding until approved. Unlike the model slots, this one is held by a script (R-L1-dispatcher.1), so no assignment line names it (SCHEMA-assignment section 2).
...
- 0.2 — 2026-09-25 — claude-ad7cc4169e888ea8 — review fix CB-05: the preamble no longer says a model may hold the slot; R-L1-dispatcher.1 is the one home — second pass pending.
